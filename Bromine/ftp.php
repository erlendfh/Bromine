...
$content["fr"]["form"] = array("Veuillez rentrer les détails du serveur pour initier la connexion FTP", "Adresse du serveur", "Nom d'utilisateur", "Mot de passe", "Port (la standard est 21)", "Classeur à lister (optionnel)", "Utiliser le mode FTP passif", "Non", "Oui", "Allons-y", "");
$content["tr"]["form"] = array("Baðlantýyý kurmak için lütfen sunucu ile ilgili detaylarý girin", "Sunucu adresi", "Kullanýcý adý", "Parola", "Port (standart deðer 21dir)", "Listelenecek klasör (opsiyonel)", "Baðlantý pasif modda yapýlsýn mý", "Hayýr", "Evet", "Baðlan", "");
...
$content["fr"]["errorlist"] = array(array("Le téléchargement a échoué", "impossible de télécharger le fichier depuis le serveur FTP (erreur de connection?)", "impossible de créer un fichier temporaire", "Vérifier que PHP peut accéder à"), "Le changement de classeur a échoué", "Le changement de permissions a échoué", "Cette permission n\\'est pas valide\\n\\nMerci d\\'utiliser le format UNIX (genre drwxrwxrwx)", "Le renommage a échoué", "L\\'effacement du classeur a échoué", "L\\'effacement du fichier a échoué", "La création du classeur a échoué", "L\\'upload a échoué", "La connexion a serveur FTP a échoué", "Erreur de sécurité: votre identifiant ne correspond pas à ceux de votre session", "ERREUR: Session invalide");
$content["tr"]["errorlist"] = array(array("Ýndirme baþarýsýz", "FTP sunucudan dosya indirilemiyor (baðlantý hatasý?)", "geçici dosya yaratýlamýyor", "PHP'nin þuraya eriþebildiðinden emin olun"), "Klasör deðiþimi baþarýsýz", "Haklarý deðiþtirme baþarýsýz", "Bu hak listesi geçerli deðil\\n\\nLütfen UNIX formatý kullanýn (drwxrwxrwx gibi)", "Yeniden isimlendirme baþarýsýz", "Klasör silme baþarýsýz", "Dosya silme baþarýsýz", "Klasör yaratma baþarýsýz", "Dosya yollama baþarýsýz", "FTP sunucusuna baðlantý baþarýsýz", "Güvenlik hatasý: Sizinle ilgili bilgiler session bilgilerinizle uyumsuz", "HATA: Session bulunamadý");
...
$content["fr"]["msgs"] = array("Vous avez été déconnecté(e) avez succès", "La déconnection a échouée", "Connecté à", "en tant que", "(<a href=\"javascript:action('disconnect')\"><b>cliquez ici</b></a> pour déconnecter)", "Le classeur courant est", "(<a href=\"javascript:var tmp=window.prompt('Entrez le nom de classeur','Nouveau Classeur');if(tmp!=null){action('mkdir',tmp)}\"><b>cliquez ici</b></a> pour créer un nouveau classeur)", "Envoyer un fichier: (limité à au maximum " . ulLimit . " MB)", "Envoyer", "Notez que votre mot de passe ne sera pas transmis à l\\'interface ZIP2FTP, vous aurez donc à le re-rentrer", "Cliquez ici pour envoyer plusieurs fichiers", "Les explications apparaitront ici", "<b>Cliquez ici</b></a> pour aller au classeur parent", "<b>Cliquez ici</b></a> pour aller à la racine", "<b>Cliquez ici</b></a> pour rafraichir", "The contenu va être dynamiquement généré en utilisant JavaScript et mis à jour quand les choses sont redimensionnées", "Au sujet de <b>\"+files[number][0]+\"</b>", "Taille", "Modifié", "Propriétaire", "Permissions", "Cliquez pour aller au classeur parent", "Au sujet de <b>\"+folders[number][0]+\"</b>", "<b>ATTENTION</b>: ce classeur est vide ou tous ces éléments sont cachés / virtuels.<br><br>Veuillez aller au parent ou à la racine pour avoir plus de contenu...", "Pointez un élément pour sa description", "( classeur parent )", "Entrer un nouveau nom", "( renommer )", "Entrer de nouvelles permissions", "( permissions )", "Etes-vous sûr de vouloir effacer ce classeur et tout son contenu", "( effacer )", "Etes-vous sûr de vouloir effacer ce fichier", "Nom du fichier / classeur");
$content["tr"]["msgs"] = array("Çýkýþ baþarýyla tamamlandý", "Çýkýþ baþarýsýz", "Sunucu:", ", kullanýcý:", "(baðlantýyý kesmek için <a href=\"javascript:action('disconnect')\"><b>buraya týklayýn</b></a>)", "Þu anki klasör", "(<a href=\"javascript:var tmp=window.prompt('Yeni klasör adý girin','Yeni Klasor');if(tmp!=null){action('mkdir',tmp)}\"><b>Yeni bir klasör yarat</b></a>)", "Dosya yolla: (en fazla " . ulLimit . " MB)", "Yolla", "Unutmayýn ki FTP parolanýz ZIP2FTP arayüzüne ulaþtýrýlmayacaktýr, dolayýsýyla tekrar girmeniz gerekmektedir", "Bir çok dosya yollamak için týklayýn", "Açýklamalar buraya gelecek", "<b>Buraya týklayarak</b></a> bir üst klasöre gidebilirsiniz", "<b>Buraya týklayarak</b></a> ana klasöre gidebilirsiniz", "<b>Buraya týklayarak</b></a> sayfayý güncelleyebilirsiniz", "Ýçerik JavaScript tarafýndan dinamik olarak yaratýlacak ve cisimler þekil deðiþtirdikçe otomatik olarak yeniden boyutlandýrýlacaktýr", "<b>\"+files[number][0]+\"</b> hakkýnda", "Boyut", "Deðiþtirilme", "Sahip", "Haklar", "Bir üst klasöre gitmek için týklayýn", "<b>\"+folders[number][0]+\"</b> hakkýnda", "<b>UYARI</b>: bu klasör boþ veya tüm elemanlarý gizli / sanal<br><br>Daha fazla içerik için bir üst veya ana klasöre gitmeniz tavsiye olunur...", "Açýklamasýný görmek için bir cismin üzerine gidin", "( bir üst klasör )", "Yeni isim girin", "( yeniden adlandýr )", "Yeni haklar girin", "( haklar )", "Bu klasörü ve tüm içeriðini silmek istediðinize emin misiniz", "( sil )", "Bu dosyayý silmek istediðinize emin misiniz", "Dosya / klasör adý");
...
$content["fr"]["views"] = array("Style de vue", "Grandes icones", "Détaillé", "<b>Cliquez ici</b></a> pour passer en vue détaillée", "<b>Cliquez ici</b></a> pour passer en vue grandes icônes");
$content["tr"]["views"] = array("Görünüm stili", "Büyük ikonlar", "Detaylý", "<b>Buraya týklayarak</b></a> detaylý görünüm stiline geçebilirsiniz", "<b>Buraya týklayarak</b></a> büyük ikonlu görünüm stiline geçebilirsiniz");
