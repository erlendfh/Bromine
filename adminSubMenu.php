...
<?php
$pages = array('editUsers.php', 'editSites.php', 'editNodes.php', 'editMisc.php', 'editUserTypeAccess.php');
$linktext = array('Edit users', 'Edit core sites', 'Edit nodes', 'Edit misc', 'Edit usertype access');
