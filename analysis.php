...
echo "<p>".$lh->getText('Suite name').":</p>"; distinctDropDown('suitename', $projectID,'',1);
echo "<p>".$lh->getText('environment').":</p>"; distinctDropDown('environment', $projectID,'',1);
echo "<p>".$lh->getText('Platform').":</p>"; distinctDropDown('platform', $projectID,'',1);
echo "<p>".$lh->getText('Browser').":</p>"; distinctDropDown('browser', $projectID,'',1);
