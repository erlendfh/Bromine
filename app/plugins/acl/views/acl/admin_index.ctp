...
<ul class="acl">
  <li><?php print $html->image('/img/tango/32x32/apps/system-users.png') ?><?php print $html->link('Manage Aros', '/admin/acl/aros') ?></li>
  <li><?php print $html->image('/img/tango/32x32/apps/preferences-system-windows.png') ?><?php print $html->link('Manage Acos', '/admin/acl/acos') ?></li>
  <li><?php print $html->image('/img/tango/32x32/emblems/emblem-readonly.png') ?><?php print $html->link('Manage Permissions', '/admin/acl/permissions') ?></li>
</ul>
<br />
