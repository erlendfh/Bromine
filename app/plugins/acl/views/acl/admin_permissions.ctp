...
<div>
  <?php print $html->image('/img/tango/32x32/emblems/emblem-readonly.png', array('align' => 'absmiddle')) ?>
...
<table>
  ...
  <tr>
    <th>
      <?php print $html->image('/img/tango/32x32/apps/system-users.png', array('align' => 'absmiddle')) ?>
      Access Request Objects
    </th>
    <th></th>
    <th>
      <?php print $html->image('/img/tango/32x32/apps/preferences-system-windows.png', array('align' => 'absmiddle')) ?>
  ...
  <tr>
    ...
    <td width="80">
      <?php print $html->image('/img/tango/32x32/actions/edit-redo.png', array('onClick' => 'acl_permission_link()', 'class' => 'acl_button')) ?>
    <td>
