<?php 
/* SVN FILE: $Id$ */
/* Test Test cases generated on: 2009-04-03 10:04:59 : 1238746679*/
App::import('Model', 'Test');

class TestTestCase extends CakeTestCase {
	var $Test = null;
	var $fixtures = array('app.test', 'app.suite', 'app.browser', 'app.operatingsystem', 'app.testcase', 'app.command', 'app.seleniumserver');
