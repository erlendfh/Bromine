...
<div class="actions">
	<ul>
		<li><?php echo $html->aclLink(__('Delete', true), array('action'=>'delete', $form->value('Coretestsuite.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Coretestsuite.id'))); ?></li>
