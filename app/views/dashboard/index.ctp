        ...
        <div id='container'>
            <table>
                ...
                <tr style='vertical-align: top;'>
                    ...
                    <td style='padding: 0px;'>
                        <div style='border: 2px solid #9bbb59; margin-left: -2px; padding-left: 4px; height: 67px; margin-top: -20px; width: 600px;'>
                            <ul>
                                <li style='font-weight: bold;'>Requirements are high level non-technical descriptions of application features</li>
                                <li>Available workflow: Add ,list requirements or view their status</li>
                            </ul>
                        </div>
                    </td>
                </tr>
                <tr style='vertical-align: top;'>
                    ...
                    <td style='padding: 0px;'>
                        <div style='border: 2px solid #8064a2; margin-left: -2px; padding-left: 4px; height: 67px; margin-top: -20px; width: 600px;'>
                            <ul>
                                <li style='font-weight: bold;'>Testcases belongs to requirements and affect their status. Testcases are step-by-step guide to test part of the application</li>
                                <li>Available workflow: Add or list testcases</li>
                            </ul>
                        </div>
                    </td>
                </tr>
                <tr style='vertical-align: top;'>
                    ...
                    <td style='padding: 0px;'>
                        <div style='border: 2px solid #4bacc6; margin-left: -2px; padding-left: 4px; height: 67px; margin-top: -20px; width: 600px;'>
                            <ul>
                                <li style='font-weight: bold;'>Testscript belongs to testcases. Testscripts are selenium scripts to execute a testcase. </li>
                                <li>Available workflow: List, Upload or Run testscripts</li>
                            </ul>
                        </div>
                    </td>
                </tr>
