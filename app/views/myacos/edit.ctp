...
<div class="actions">
	<ul>
		<li><?php echo $html->aclLink(__('Delete', true), array('action'=>'delete', $form->value('Myaco.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Myaco.id'))); ?></li>
