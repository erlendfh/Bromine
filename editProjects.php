    ...
    <body>
        ...
        <form action='saveProjects.php' method='post'>
            <table>
                <tr>
                    <th align='left'>
                        <?php $lh->getText('Delete') ?>
                    </th>
                    <th align='left'>
                        <?php $lh->getText('Name') ?>
                    </th>
                    <th align='left'>
                        <?php $lh->getText('Description') ?>
                    </th>
                    <th align='left'>
                        <?php $lh->getText('Assigned to') ?>
                    </th>
                    <th align='left'>
                        <?php $lh->getText('Sites to test') ?>
                    </th> 
                </tr> 
                <?php
                    for ($i = 0;$i < $num;$i++) {
                ...
                ?> 
                <p>
                    <?php echo $lh->getText('Add project') ?>
                </p>
                <div>
                    <table>
                        <tr>
                        ...
                        <tr valign='top'>
                            ...
                            <td align='left'>
                                <textarea cols='80' rows='8' name='newdescription'></textarea>
                            </td>
                            <td>
                ...
                <div>
                    <input type='submit' value='<?php echo $lh->getText('Submit'); ?>' />
                </div>
        </form>
    </body>
</html>
