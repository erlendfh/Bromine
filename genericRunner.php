        ...
        <div id='reqdiv' style="display:none;">
          <table>
              ...
              <td>
                <?php
                  ...
                  for ($i=0;$i<$outer_num_row;$i++){
                    ...
                    if($req==$r_id){echo " selected='selected'";}
                    echo ">".$r_name."</option>";
                  }
                  ...
                  $inner_result = $dbh->select(" 
                          ...
                          "WHERE TRM_requirements.ID = '$req' AND 
            ...
            <?php
              ...
              "WHERE TRM_ReqsOSBrows.r_id = '$req' AND 
    ...
    <fieldset style='width: 600px;'> 
      ...
      <div id='multitest' style="display:none;">   
          <table>
              ...
              <td>
                <?php
                  ...
                  while($row = mysql_fetch_array($testcaseresult)){
                    ...
                    if(!file_exists("RC/rc-php/$p_name/$testcasename.php")){echo "disabled='disabled' ";} //HARDCODED!!!!!!!
                    if(in_array($testcasename,$tests)){echo "checked='checked'";}
            ...
            <?php
            if(count($tests)>0){
              $rresult = $dbh->select("TRM_OS, TRM_browser, TRM_nodes_browsers, TRM_nodes",
              "WHERE TRM_nodes_browsers.n_id=TRM_nodes.id AND 
