...
if ($newnr2 == '' && ($newname2 != '' && $newdescription2 != '')) {
    $error.= "Krav Nr må ikke være tomt";
}
if ($newname2 == '' && ($newnr2 != '' && $newdescription2 != '')) {
    $error.= "Krav navn må ikke være tomt";
}
if ($newdescription2 == '' && ($newname2 != '' && $newnr2 != '')) {
    $error.= "Krav beskrivelse må ikke være tom";
}
if ($newnr2 != '' && $newname2 != '' && $newdescription2 != '') {
