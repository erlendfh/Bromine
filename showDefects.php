  ...
  <div id="object1" style="position:absolute; background-color:#FFFFDD;color:black;border-color:black;border-width:20px; visibility:visible; left:25px; top:-100px; z-index:1" onmouseover="Popup.over()" onmouseout="Popup.out()">
    ...
    if ($p_id != ''){
      ...
      if ($t_id == NULL){
        ...
        $inner2 = $lh->select('
        TRM_test, TRM_suite, TRM_ReqsTests, TRM_requirements',
        "WHERE 
      ...
      echo "
        <tr style='background-color: $bgcolor;'>
          ...
          <td>";
          if($t_id!='N/A'){echo "<a href='showReport.php?id=$s_id&amp;highlight=$t_id'>";}
          echo "$t_id";
          if($t_id!='N/A'){echo "</a>";}
          echo "</td>
          <td>";
    ...
    }else{ echo "<h1>".$lh->getText('Choose project')."</h1>"; }?>
  </body>
</html>
