...
$id = $_SESSION["sid"];
if (isset($_POST['tShowPassed'])) {
    $tShowPassed = $_POST['tShowPassed'];
}
if (isset($_POST['tShowFailed'])) {
    $tShowFailed = $_POST['tShowFailed'];
}
if (isset($_POST['tShowHelp'])) {
    $tShowHelp = $_POST['tShowHelp'];
}
if (isset($_POST['cShowPassed'])) {
    $cShowPassed = $_POST['cShowPassed'];
}
if (isset($_POST['cShowFailed'])) {
    $cShowFailed = $_POST['cShowFailed'];
}
if (isset($_POST['cShowNotdone'])) {
    $cShowNotdone = $_POST['cShowNotdone'];
}
if (isset($_POST['cShowDone'])) {
    $cShowDone = $_POST['cShowDone'];
}
?>
<?php
$db = new DBHandler();
...
<?php echo "<form method='post' action='?id=$id'>"; ?>
  <fieldset style='border: none;'>
    ...
    <input type='checkbox' name='tShowPassed' value='1' <?php if ($tShowPassed) {
    echo "checked='checked'";
} ?>/>
    <?php echo $lh->getText('Test succeded'); ?><br />
    <input type='checkbox' name='tShowFailed' value='1' <?php if ($tShowFailed) {
    echo "checked='checked'";
} ?>/>
    <?php echo $lh->getText('Test failed'); ?><br />
    <input type='checkbox' name='tShowHelp' value='1' <?php if ($tShowHelp) {
    echo "checked='checked'";
} ?>/>
    <?php echo $lh->getText('Help text'); ?><br />
    <input type='checkbox' name='cShowPassed' value='1' <?php if ($cShowPassed) {
    echo "checked='checked'";
} ?>/>
    <?php echo $lh->getText('Commands succeded'); ?><br />
    <input type='checkbox' name='cShowFailed' value='1' <?php if ($cShowFailed) {
    echo "checked='checked'";
} ?>/>
    <?php echo $lh->getText('Commands failed'); ?><br />
    <input type='checkbox' name='cShowDone' value='1' <?php if ($cShowDone) {
    echo "checked='checked'";
} ?>/>
    <?php echo $lh->getText('Commands done'); ?><br />
    <input type='checkbox' name='cShowNotdone' value='1' <?php if ($cShowNotdone) {
    echo "checked='checked'";
} ?>/>
